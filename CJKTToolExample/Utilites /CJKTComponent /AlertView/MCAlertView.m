...
- (void)setUpConfig
{
    _cancleAlertActionColor =  MC_RGBColor(153,153,153);
    _defaultAlertActionColor = MC_blackColor;
    
    _alertViewTitleColor = MC_blackColor;
    _alertViewMessagerColor = MC_blackColor;
}
