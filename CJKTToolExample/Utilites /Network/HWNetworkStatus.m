...
NSString * const kHWReachabilityChangedNotification = @"kHWReachabilityChangedNotification";

@implementation HWNetworkStatus

+ (instancetype)shareNetworkStatus
{
    static HWNetworkStatus *instance = NULL;
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kHWReachabilityChangedNotification object:NULL];
}
...
- (KHWNetworkModeStatus)currentNetworkStatus
{
    ...
    switch (status) {
        case NotReachable:
            return KHWNotReachable;
            break;
        case ReachableViaWiFi:
            return KHWReachableViaWiFi;
            break;
        case ReachableViaWWAN:
            return KHWReachableViaWWAN;
            break;
        default:
            return KHWNotReachable;
            break;
